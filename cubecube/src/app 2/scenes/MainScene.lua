...
function MainScene:generateShapes()
  -- 下面的三个图形
	...
	local leftType = Res["CUBT_TYPE_"..randomExchanger(math.random(1,1000))]
	...
	local middleType = Res["CUBT_TYPE_"..randomExchanger(math.random(1,1000))]
	...
	local rightType = Res["CUBT_TYPE_"..randomExchanger(math.random(1,1000))]
